...
public interface BookingRepository extends JpaRepository<Booking, Long> {
        ...
        List<Booking> findByCheckOutBetween(@Param("startDate") LocalDate startDate,
        ...
        @Query("SELECT b FROM Booking b WHERE b.room.id = :roomId " +
                        "AND b.status IN (BookingStatus.PENDING, BookingStatus.CONFIRMED, BookingStatus.CHECKED_IN) " +
